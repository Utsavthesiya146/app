...
# Dynamic Logo Path (cross-platform & working after deployment)
...
<ul>
    <li>✨ instructions :</li>
    <li>👤 Go to <b>Profile</b> page and create your identity.</li>
    <li>🔧 Edit your identity anytime in the <b>Profile</b> page.</li>
    <li>🗳️ Support your favorite profiles in the <b>Vote</b> section.</li>
    <li>🌟 The most voted user becomes the Spotlight for 24 hours!</li>
</ul>
</div>
""", unsafe_allow_html=True)
