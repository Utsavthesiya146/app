...
from sqlite_config import create_posts_table
from database import create_user, get_user_by_name
from timer import get_remaining_time
from spotlight import rotate_spotlight
...
<ul>
    <li>✨ Instructions:</li>
    <li>👤 Go to <b>Profile</b> page and create your identity.</li>
    <li>🔧 You can also edit your profile anytime.</li>
    <li>🗳️ Visit <b>Vote</b> to support your favorite profile.</li>
    <li>🌟 The most voted user is crowned the spotlight for 24 hours!</li>
</ul>
</div>
